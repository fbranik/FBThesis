...
problemSizeX=(16384 32768 32768 40960)
problemSizeY=(32768 32768 65536 65536)

Px=(8 16 16 20)
Py=(16 16 32 32)

NumPr=(128 256 512 640)

for iVersion in CompBoundJacobi MemBoundJacobi CompBoundJacobiSocketBarrier MemBoundJacobiSocketBarrier; do
